  ...
  return /* html */ `
    ...
    >
      <g>
        ...
        >
          <animate
            ...
            values="15 300;74.44083589134416 300;15 300"
            keyTimes="0;0.5;1"
            dur="1.2048192771084336s"
            repeatCount="indefinite"
            calcMode="linear"
            keySplines="0 0.4 0.6 1;0.4 0 1 0.6"
            begin="-0.07481927710843374s"
          ></animate>
        </circle>
        <circle
          cx="50"
        ...
        >
          <animate
            attributeName="stroke-dasharray"
            values="15 300;61.15416091336993 300;15 300"
            keyTimes="0;0.5;1"
            dur="1.2048192771084336s"
            repeatCount="indefinite"
            calcMode="linear"
        ...
        >
          <animate
            attributeName="stroke-dasharray"
            values="15 300;89.145751456855 300;15 300"
            keyTimes="0;0.5;1"
            dur="1.2048192771084336s"
            repeatCount="indefinite"
            calcMode="linear"
      ...
      <g>
        ...
        ></path>
        <path fill="none" stroke="#6c6c6c" d="M90.9,36.4c1.1-1.1,2.7-1.6,4.3-1.9"></path>
        <path fill="none" stroke="#6c6c6c" d="M91.6,37.5c1.3-0.5,2.8-0.8,4.2-0.7"></path>
        <path
          fill="none"
          stroke="#6c6c6c"
          d="M91.7,38.8c0.2-0.1,0.4-0.1,0.7-0.1c1.2-0.1,2.5,0,3.8,0.3"
        ></path>
        <path fill="none" stroke="#6c6c6c" d="M85,38.4c-1.6-0.1-3.1,0.6-4.6,1.2"></path>
        <path fill="none" stroke="#6c6c6c" d="M85,39.5c-1.4,0.3-2.8,0.9-4,1.6"></path>
        <path
          fill="none"
          stroke="#6c6c6c"
